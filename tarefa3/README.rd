...
- **Estimar a trajetória 3D** da bola com base nas coordenadas 2D fornecidas pelas câmeras.
- **Gerar gráficos 3D** para visualizar a trajetória da bola.
- **Adicionar triângulos orientados** no gráfico para representar a orientação da bola em cada ponto da trajetória.
